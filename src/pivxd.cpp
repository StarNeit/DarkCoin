 ...
 *
 * This is the developer documentation of the reference client for an experimental new digital currency called DARKCOIN (http://www.pivx.org),
...
bool AppInit(int argc, char* argv[])
{
    ...
    if (mapArgs.count("-?") || mapArgs.count("-help") || mapArgs.count("-version")) {
        ...
        if (mapArgs.count("-version")) {
            ...
            strUsage += "\n" + _("Usage:") + "\n" +
                        "  pivxd [options]                     " + _("Start Darkcoin Core Daemon") + "\n";
