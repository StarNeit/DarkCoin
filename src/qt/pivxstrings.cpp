...
QT_TRANSLATE_NOOP("pivx-core", ""
"To use pivxd, or the -server option to pivx-qt, you must set an rpcpassword "
...
QT_TRANSLATE_NOOP("pivx-core", "Acceptable ciphers (default: %s)"),
...
QT_TRANSLATE_NOOP("pivx-core", "Invalid -proxy address or hostname: '%s'"),
...
QT_TRANSLATE_NOOP("pivx-core", "RPC support for HTTP persistent connections (default: %d)"),
...
QT_TRANSLATE_NOOP("pivx-core", "failed to validate zerocoin"),
