                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Piv from zDrk"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zDrk"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zDrk));
