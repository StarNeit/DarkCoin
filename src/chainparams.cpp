...
public:
    CMainParams()
    {
        ...
        nDefaultPort = /*51472*/51914;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // DARKCOIN starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // DARKCOIN: 1 day
        nTargetSpacing = 1 * 60;  // DARKCOIN: 1 minute
        nMaturity = 100;
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Darkcoin: 1 day
        nTargetSpacing = 1 * 60;        // Darkcoin: 1 minutes
