...
DARKCOIN-Project/DARKCOIN repository.
...
Setup
---------
Configuring the github-merge tool for the DARKCOIN repository is done in the following way:

    git config githubmerge.repository DARKCOIN-Project/DARKCOIN
...
A script to optimize png files in the DARKCOIN
