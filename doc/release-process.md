...
* Update translations (ping Fuzzbawls on Slack) see [translation_process.md](https://github.com/DARKCOIN-Project/DARKCOIN/blob/master/doc/translation_process.md#synchronising-translations).
...
### DARKCOIN maintainers/release engineers, suggestion for writing release notes
...
### Build and sign DARKCOIN Core for Linux, Windows, and OS X:
...
- Detached signatures will then be committed to the [pivx-detached-sigs](https://github.com/DARKCOIN-Project/pivx-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/DARKCOIN-Project/DARKCOIN/releases/new) with a link to the archived release notes.
