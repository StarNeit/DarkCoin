UNIX BUILD NOTES
====================
Some notes on how to build DARKCOIN in Unix.
...
memory available when compiling DARKCOIN Core. With 512MB of memory or less
...
If you want to build DARKCOIN-Qt, make sure that the required packages for Qt development
...
# Configure DARKCOIN Core to use our own-built instance of BDB
cd $DARKCOIN_ROOT
...
Security
--------
To help make your DARKCOIN installation more secure by making certain attacks impossible to
