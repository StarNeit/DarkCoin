...
*Setup instructions for a gitian build of DARKCOIN using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the DARKCOIN
...
- [Building DARKCOIN](#building-pivx)
...
To build DARKCOIN (for Linux, OSX and Windows) just follow the steps under 'perform
