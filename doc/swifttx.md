...
This mechanism has been integrated into Bitcore-Node-DARKCOIN which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/DARKCOIN-Project/insight-api-pivx#web-socket-api](https://github.com/DARKCOIN-Project/insight-api-pivx#web-socket-api) 
* API: [https://github.com/DARKCOIN-Project/insight-api-pivx#swifttx-transactions](https://github.com/DARKCOIN-Project/insight-api-pivx#swifttx-transactions) 
...
By default, the DARKCOIN Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the DARKCOIN Core daemon:
