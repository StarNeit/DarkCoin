...
Darkcoin now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ DARKCOIN, _12_ times over the course of a year totaling _24000_ DARKCOIN.
...
When block `1000000` is reached you'll receive a payment for `1200` DARKCOIN.
 ...
 * vote-many          - Vote on a Darkcoin initiative
 * vote-alias         - Vote on a Darkcoin initiative
 * vote               - Vote on a Darkcoin initiative/budget
