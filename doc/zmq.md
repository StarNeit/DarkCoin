...
The DARKCOIN Core daemon can be configured to act as a trusted "border
...
The ZeroMQ feature in DARKCOIN Core requires ZeroMQ API version 4.x or
...
using. DARKCOINd appends an up-counting sequence number to each
