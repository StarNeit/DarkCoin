Contributing to DARKCOIN Core
============================

The DARKCOIN Core project operates an open contributor model where anyone is
...
The following applies to code changes to the DARKCOIN Core project, and is not to be
confused with overall DARKCOIN Network Protocol consensus changes.

Whether a pull request is merged into DARKCOIN Core rests with the project merge
...
Patches that change DARKCOIN consensus rules are considerably more involved than
...
Where a patch set proposes to change the DARKCOIN consensus, it must have been
...
The project leader is the release manager for each DARKCOIN Core release.
